      ...
      >
        ...
        >
          <div className="sm-logo flex items-center select-none pointer-events-auto shrink-0" aria-label="Logo">
            <Link to="/" onClick={closeMenu} className="flex items-center gap-1 text-lg sm:text-2xl font-heading font-black tracking-tighter text-primary drop-shadow-[0_0_12px_rgba(220,248,54,0.4)] hover:drop-shadow-[0_0_20px_rgba(220,248,54,0.8)] transition-all duration-300">
              <img src="/logo.png" alt="VALQORE" className="w-6 h-6 sm:w-8 sm:h-8 object-contain drop-shadow-[0_0_8px_rgba(220,248,54,0.5)]" />
