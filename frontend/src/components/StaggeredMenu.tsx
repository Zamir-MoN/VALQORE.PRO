      ...
      >
        ...
        >
          <div className="sm-logo flex items-center select-none pointer-events-auto shrink-0" aria-label="Logo">
            <Link to="/" onClick={closeMenu} className="flex items-center gap-2.5 text-lg sm:text-2xl font-heading font-black tracking-tighter text-primary drop-shadow-[0_0_12px_rgba(220,248,54,0.4)] hover:drop-shadow-[0_0_20px_rgba(220,248,54,0.8)] transition-all duration-300">
              <img src="/logo.png" alt="VALQORE Logo" className="w-6 h-6 sm:w-8 sm:h-8 object-contain drop-shadow-[0_0_8px_rgba(220,248,54,0.5)]" />
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-full bg-background flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] pointer-events-auto border-l border-white/5"
          ...
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
              ...
              {items && items.length ? (
                items.map((it, idx) => (
                  <li className="sm-panel-itemWrap relative overflow-hidden leading-none" key={it.label + idx}>
                    <Link
                      className="sm-panel-item relative text-white font-heading font-black text-[3rem] sm:text-[4rem] cursor-pointer leading-[1.1] tracking-[-2px] uppercase transition-[background,color] duration-150 ease-linear inline-block no-underline pr-[1.4em] hover:drop-shadow-[0_0_10px_rgba(220,248,54,0.4)]"
                      to={it.link}
                      onClick={(e) => {
                        if (it.onClick) {
                          e.preventDefault();
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              <div className="sm-socials mt-auto pt-8 flex flex-col gap-3" aria-label="Social links">
                <h3 className="sm-socials-title m-0 text-base font-bold [color:var(--sm-accent,#ff0000)] uppercase tracking-wider">Socials</h3>
                <ul
                  ...
                  {socialItems.map((s, i) => (
                    <li key={s.label + i} className="sm-socials-item">
                      <a
                        ...
                        className="sm-socials-link text-lg font-bold text-text-secondary no-underline relative inline-block py-[2px] transition-[color,opacity] duration-300 ease-linear"
                      >
                        {s.label}
                      </a>
                    </li>
...
.sm-scope .staggered-menu-header { position: absolute; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; background: transparent; pointer-events: none; z-index: 20; }
.sm-scope .staggered-menu-header > * { pointer-events: auto; }
.sm-scope .sm-logo { display: flex; align-items: center; user-select: none; }
.sm-scope .sm-logo-img { display: block; height: 32px; width: auto; object-fit: contain; }
.sm-scope .sm-toggle { position: relative; display: inline-flex; align-items: center; gap: 0.5rem; background: transparent; border: none; cursor: pointer; color: #e9e9ef; font-weight: 700; line-height: 1; overflow: visible; }
...
.sm-scope .sm-panel-itemWrap { position: relative; overflow: hidden; line-height: 1.1; margin-bottom: 0.5rem; }
...
.sm-scope .sm-socials-title { margin: 0; font-size: 1rem; font-weight: 700; color: var(--sm-accent, #dcf836); }
...
.sm-scope .sm-socials-list .sm-socials-link:focus-visible { opacity: 1; color: white; }
...
.sm-scope .sm-panel-item { position: relative; cursor: pointer; text-transform: uppercase; transition: background 0.25s, color 0.25s; display: inline-block; text-decoration: none; padding-right: 1.4em; }
.sm-scope .sm-panel-itemLabel { display: inline-block; will-change: transform; transform-origin: 50% 100%; }
.sm-scope .sm-panel-item:hover { color: var(--sm-accent, #dcf836); }
