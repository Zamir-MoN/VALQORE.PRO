  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-12 left-0 w-full flex items-center justify-between px-3 sm:px-6 py-4 sm:py-6 bg-gradient-to-b from-background/80 to-transparent pointer-events-none z-20"
