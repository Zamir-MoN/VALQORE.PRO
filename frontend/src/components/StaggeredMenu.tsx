  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between px-6 py-6 bg-gradient-to-b from-background/80 to-transparent pointer-events-none z-20"
