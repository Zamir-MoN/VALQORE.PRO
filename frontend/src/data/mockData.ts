...
export const CATEGORIES = [
  { id: '1', name: 'Action', icon: 'Swords' },
  { id: '2', name: 'RPG', icon: 'Shield' },
  { id: '3', name: 'Adventure', icon: 'Map' },
  { id: '4', name: 'FPS', icon: 'Crosshair' },
  { id: '5', name: 'Open World', icon: 'Globe' },
  { id: '6', name: 'Horror', icon: 'Ghost' },
  { id: '7', name: 'Simulation', icon: 'Car' },
...
export const TESTIMONIALS = [
  {
    ...
    user: 'AlexGamer99',
    rating: 5,
    comment: 'Valqore has the best UI of any game store. Period. Downloads are lightning fast.',
  ...
  },
  {
    ...
    user: 'CyberNinja',
    rating: 5,
    comment: 'The exclusive deals are insane. I saved $100 on AAA titles this month alone.',
  ...
  },
  {
    ...
    user: 'RetroPlayer',
    rating: 4,
    comment: 'Incredible curated selections. Found so many indie gems here.',
